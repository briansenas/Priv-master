...
class Inpainter():
    ...
    def _find_front(self):
        ...
        self.front= (cv.Laplacian(self.working_mask,cv.CV_64F)>0).astype('uint8')
    ...
    def _calc_gradient_matrix(self):
        ...
        grey_image = cv.cvtColor(self.working_image,cv.COLOR_RGB2GRAY)
        grey_image[self.working_mask == 1] = 0
    ...
    def _find_source_patch(self, target_pixel):
        ...
        lab_image = cv.cvtColor(self.working_image,cv.COLOR_RGB2LAB)
